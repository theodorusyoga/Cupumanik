	...
	<div class="main">
		...
		<div class="preview">
			...
			<div class="images batiklink" >
				 <div class="column">
					<img id="img1" src="images/home.png" class="previewimg batiklink" />
				</div>
				<div class="column">
					<img id="img2" src="images/home.png" class="previewimg batiklink" />
				</div>
				<div class="column">
					<img id="img3" src="images/home.png" class="previewimg batiklink" />
				</div>  
			</div>
			...
			<div class="images guesthouselink" >
				 <div class="column">
					<img id="img1" src="images/home.png" class="previewimg guesthouselink" />
				</div>
				<div class="column">
					<img id="img2" src="images/home.png" class="previewimg guesthouselink" />
				</div>
				<div class="column">
					<img id="img3" src="images/home.png" class="previewimg guesthouselink" />
				</div>  
			</div>
		</div>
		<div class="foot">
