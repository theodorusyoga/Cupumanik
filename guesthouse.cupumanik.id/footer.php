...
function getBatikFooter() {
	...
	$footer .= "<ul>";
	$footer .= "<li><a href=\"http://".str_replace('guesthouse', 'batik', $_SERVER['HTTP_HOST'])."\">Cupumanik Batik</a></li>";
	$footer .= "<li><a href=\"http://".str_replace('guesthouse', 'furniture', $_SERVER['HTTP_HOST'])."\">Cupumanik Furniture</a></li>";
	$footer .= "</ul>";
	$footer .= "</div>";
